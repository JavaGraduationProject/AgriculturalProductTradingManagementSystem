...
<div class="w1200" style="margin-bottom: 60px;">
	<div class="position"><a href="#">首页</a> > <a href="#">会员中心</a> > <a href="#">我的帖子</a></div>
        ...
        <div class="c_r_o" style="margin: 0px;padding: 0px;">
            ...
            <table class="ordertable"  bordercolor="#E8E8E8" cellpadding="1" cellspacing="0" >
                ...
                <tr class="thitems" style="height: 50px">
                    <td style="width: 90px;font-size:12px;"> <a href="bbsShow.do?id=${bbs.id }">${bbs.title}</a></td>
                    <td style="width: 120px;font-size:12px;">${bbs.savetime}</td>
                    <td style="width: 120px;font-size:12px;">
                    <a href="toBbsEdit.do?id=${bbs.id}" style="color: green">【编辑】</a>
                    <a href="bbsDel.do?id=${bbs.id}" style="color: green">【删除】</a>
                    </td>
                </tr>
                </c:forEach>
                ...
                <tr>
                	<td colspan="6">
					  <a href="mybbsList.do?pageNum=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}">上一页</a>
					  <c:forEach begin="1" end="${pageInfo.pages}" varStatus="status">
					  <a href="mybbsList.do?pageNum=${status.count}" ${status.count eq pageInfo.pageNum ?"class='page wt1080 acvtive'":""}}>${status.count}</a>
					  </c:forEach>
					  <a href="mybbsList.do?pageNum=${pageInfo.hasNextPage==false? pageInfo.pages : pageInfo.nextPage}">下一页</a>
                	</td>
                </tr>
