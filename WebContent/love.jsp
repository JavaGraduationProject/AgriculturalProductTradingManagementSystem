...
<div class="content">
    ...
    <!-------------------位置------------------>
    <div class="place">
        位置：<a class="check" href="#">猜你喜欢</a>共<span class="number">${fn:length(tjproductlist)}</span>件商品
    </div>
    <!----------------产品详细------------------->
    <div class="product">
        <ul>
        <c:forEach items="${tjproductlist}" var="product">
            <li>
                <div class="pic"><a href="productDetails.do?id=${product.id}"><img src="upload/${product.filename}" style="height: 240px"></a></div>
