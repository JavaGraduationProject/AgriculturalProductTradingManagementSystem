                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form"  method="post"  action="<%=path %>/admin/categoryAdd.do">
                                <input type="hidden" name="fatherid" value="<%=fatherid %>"/>
                                <div class="form-group">
                                <label for="exampleInputEmail1">商品类别名称</label>
                                <input type="text" class="form-control" name="name" id="name"  placeholder="商品类别名称" required oninvalid="setCustomValidity('请输入商品类别名称')" oninput="setCustomValidity('');">
                                </div>
